...
// export function check(_values: RepeaterPreviewProps): Problem[] {
...
export function getPreview(values: RepeaterPreviewProps, isDarkMode: boolean, _version: number[]): PreviewProps {
...
// export function getCustomCaption(values: RepeaterPreviewProps, platform: Platform): string {
//     return "Repeater";
// }
